...
if __name__ == '__main__':
    ...
    EPI_fea = np.loadtxt(workdir+"/output/energy_feature/GB1/EPI.txt",dtype=bytes).astype(str)
    ETOR_fea = np.loadtxt(workdir+"/output/energy_feature/GB1/ETOR.txt",dtype=bytes).astype(str)
