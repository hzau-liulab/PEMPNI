import sys
#import os
#sys.path.append(r'/home/yjiang/modeller/modeller-9.25/MODELLER/modlib')
#sys.path.append(r'/home/jiangyao/bin/modeller9.25/modlib/')
...
# modeller  window:   mutate_model.py D120A 1AAY_A  120 ALA A >1AAY.log
#
...
#first argument
outname = sys.argv[2]
modelname, respos, restyp, chain, = sys.argv[3:]
...
#os.remove(file_dir+modelname+restyp+respos+'.tmp')
