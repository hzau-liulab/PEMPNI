...
system "/home/yaojiang/anaconda3/bin/python $workdir/scripts/MPD-regression.py $workdir $mut_name";

#########################Random forest classification#############################
system "/home/yaojiang/anaconda3/bin/python $workdir/scripts/MPD-classification.py $workdir $mut_name";
