...
/home/jiangyao/amber18/bin/MMPBSA.py -O -i mmpbsa_residue_pair.in -o Final_result_mmpbsa_GB1_pair.dat -do FINAL_DECOMP_MMPBSA_GB1_pair.dat -sp com_solvated.prmtop -cp com.prmtop -rp pro.prmtop -lp dna.prmtop -y last.crd > mmpbsa.log;
#job=` echo ~+ | cut -f 5 -d "/"` 
#sshpass -p jiangyao scp -P 22 ./FINAL_DECOMP_MMPBSA_GB1_pair.dat jiangyao@218.199.68.196:/var/www/html/PEMPNI/job/$job/energy_feature/GB1